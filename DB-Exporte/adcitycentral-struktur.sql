...
--
-- Table structure for table `vms_konten`
--

DROP TABLE IF EXISTS `vms_konten`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `vms_konten` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `k_username` varchar(100) NOT NULL,
  `k_passwort` varchar(100) NOT NULL,
  `k_guthaben` decimal(20,8) DEFAULT 0.00000000,
...
--
-- Table structure for table `vms_schnittstelle`
--

DROP TABLE IF EXISTS `vms_schnittstelle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `vms_schnittstelle` (
  ...
  `kontostand` decimal(20,8) DEFAULT 0.00000000,
...
--
-- Table structure for table `vms_schnittstelle_buchungen`
--

DROP TABLE IF EXISTS `vms_schnittstelle_buchungen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `vms_schnittstelle_buchungen` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `schnittstelle_id` int(11) NOT NULL,
...
--
-- Table structure for table `wf_mail_designs`
--

DROP TABLE IF EXISTS `wf_mail_designs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wf_mail_designs` (
...
--
-- Table structure for table `wp_acm_alerts`
--

DROP TABLE IF EXISTS `wp_acm_alerts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_acm_alerts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_resolved` (`resolved`,`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=646 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_acm_checks`
--

DROP TABLE IF EXISTS `wp_acm_checks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_acm_checks` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `site_id` int(10) unsigned NOT NULL,
  ...
  `ssl_days` smallint(6) NOT NULL DEFAULT 0,
  `wp_version` varchar(20) NOT NULL DEFAULT '',
  `plugin_ver` varchar(20) NOT NULL DEFAULT '',
  `php_version` varchar(20) NOT NULL DEFAULT '',
  `db_size_mb` decimal(10,2) NOT NULL DEFAULT 0.00,
  `error_msg` varchar(500) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `idx_site_date` (`site_id`,`checked_at`)
) ENGINE=InnoDB AUTO_INCREMENT=47055 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_acm_sites`
--

DROP TABLE IF EXISTS `wp_acm_sites`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_acm_sites` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `url` varchar(300) NOT NULL,
  `local_db` varchar(100) NOT NULL DEFAULT '',
  `local_path` varchar(300) NOT NULL DEFAULT '',
  `role` varchar(30) NOT NULL DEFAULT 'network',
...
) ENGINE=InnoDB AUTO_INCREMENT=3257 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `wp_ai_statistics`
--

DROP TABLE IF EXISTS `wp_ai_statistics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_ai_statistics` (
...
--
-- Table structure for table `wp_gdpr_cookie_post_cookies`
--
...
CREATE TABLE `wp_gdpr_cookie_post_cookies` (
  `id_gdpr_cookie_post_cookies` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `wp_gdpr_cookie_scan_categories`
--
...
CREATE TABLE `wp_gdpr_cookie_scan_categories` (
  `id_gdpr_cookie_category` int(11) NOT NULL AUTO_INCREMENT,
  `gdpr_cookie_category_name` varchar(50) NOT NULL,
  `gdpr_cookie_category_slug` varchar(50) NOT NULL,
  `gdpr_cookie_category_description` text DEFAULT NULL,
...
--
-- Table structure for table `wp_ngm_debt_log`
--

DROP TABLE IF EXISTS `wp_ngm_debt_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_ngm_debt_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `wp_ngm_rally_pool_contributions`
--

DROP TABLE IF EXISTS `wp_ngm_rally_pool_contributions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_ngm_rally_pool_contributions` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `rally_id` int(10) unsigned NOT NULL,
  ...
  `amount_gsc` decimal(38,8) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
...
CREATE TABLE `wp_ngm_rallys` (
  ...
  `payout_mode` varchar(20) NOT NULL DEFAULT 'fixed',
  `status` tinyint(4) NOT NULL DEFAULT 0,
...
) ENGINE=InnoDB AUTO_INCREMENT=38946 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wp_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=InnoDB AUTO_INCREMENT=10023 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wp_statistics_visitor` (
  ...
  KEY `ip` (`ip`)
) ENGINE=InnoDB AUTO_INCREMENT=15937 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wp_statistics_visitor_relationships` (
  ...
  KEY `visitor_id` (`visitor_id`),
  KEY `page_id` (`page_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19818 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `wp_wf_affiliate_coupons`
--

DROP TABLE IF EXISTS `wp_wf_affiliate_coupons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_affiliate_coupons` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL DEFAULT '',
  `shop_name` varchar(100) NOT NULL DEFAULT '',
  `logo_url` text DEFAULT NULL,
  `coupon_code` varchar(100) NOT NULL DEFAULT '',
  `discount_text` varchar(200) NOT NULL DEFAULT '',
  `description` text DEFAULT NULL,
...
CREATE TABLE `wp_wf_campaigns` (
  ...
  `remaining` int(11) unsigned NOT NULL DEFAULT 0,
  `clicks_delivered` int(11) unsigned NOT NULL DEFAULT 0,
...
--
-- Table structure for table `wp_wf_coupon_favorites`
--

DROP TABLE IF EXISTS `wp_wf_coupon_favorites`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_coupon_favorites` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
...
--
-- Table structure for table `wp_wf_deposit_orders`
--

DROP TABLE IF EXISTS `wp_wf_deposit_orders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_deposit_orders` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `cp_amount` bigint(20) unsigned NOT NULL DEFAULT 0,
  `eur_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `method` varchar(20) NOT NULL DEFAULT 'sepa',
  `payment_method` varchar(50) NOT NULL DEFAULT 'sepa',
  `label` varchar(100) NOT NULL DEFAULT '',
  `status` enum('pending','paid','confirmed','delivered','cancelled') NOT NULL DEFAULT 'pending',
  `ref_code` varchar(20) NOT NULL DEFAULT '',
  `note` text DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `wp_wf_flatrates`
--

DROP TABLE IF EXISTS `wp_wf_flatrates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_flatrates` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `art` varchar(50) NOT NULL DEFAULT '',
  `offen` int(11) NOT NULL DEFAULT -1,
  `kamp_laufzeit` int(11) NOT NULL DEFAULT 30,
  `kamp_klicks` int(11) NOT NULL DEFAULT 500,
  `kamp_zeit` int(11) NOT NULL DEFAULT 30,
  `kamp_reload` int(11) NOT NULL DEFAULT 2,
  `kamp_wert` decimal(10,4) NOT NULL DEFAULT 0.0000,
  `kamp_preis` decimal(10,4) NOT NULL DEFAULT 0.0000,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wp_wf_jackpot` (
  ...
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=1758 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6361 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `wp_wf_subscription_plans`
--

DROP TABLE IF EXISTS `wp_wf_subscription_plans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_subscription_plans` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `slug` varchar(32) NOT NULL COMMENT 'basic, pro, premium, enterprise',
  `name` varchar(100) NOT NULL COMMENT 'Anzeigename',
  `description` text DEFAULT NULL COMMENT 'Beschreibung des Plans',
  `slots_included` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Anzahl Slots im Plan',
  `min_rent_months` int(10) unsigned NOT NULL DEFAULT 1 COMMENT 'Mindestmietzeit',
  `max_rent_months` int(10) unsigned NOT NULL DEFAULT 12 COMMENT 'Maximale Mietzeit',
  `discount_pct` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT 'Rabatt in %',
  `monthly_fee` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Monatliche ABO-Gebühr',
  `currency` varchar(3) NOT NULL DEFAULT 'CP',
  `allows_renewal` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Auto-Renewal erlaubt',
  `is_active` tinyint(1) NOT NULL DEFAULT 1 COMMENT '0=inaktiv, 1=aktiv',
  `sort_order` int(10) unsigned NOT NULL DEFAULT 0,
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  ...
  KEY `is_active` (`is_active`),
  KEY `sort_order` (`sort_order`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Walls ABO-Pläne';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wp_wf_transactions` (
  ...
  `user_id` bigint(20) unsigned NOT NULL,
  `amount` decimal(38,8) NOT NULL DEFAULT 0.00000000,
  `currency` varchar(10) NOT NULL DEFAULT 'gsc',
  ...
  KEY `type` (`type`),
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=3768 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `wp_wf_user_websites`
--

DROP TABLE IF EXISTS `wp_wf_user_websites`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_user_websites` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `url` varchar(500) NOT NULL,
  `title` varchar(200) NOT NULL DEFAULT '',
  `description` text DEFAULT NULL,
  `type` enum('current','favorite') NOT NULL DEFAULT 'current',
...
--
-- Table structure for table `wp_wf_wall_agb`
--

DROP TABLE IF EXISTS `wp_wf_wall_agb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_wall_agb` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `version` varchar(20) NOT NULL COMMENT 'z.B. v2.1',
  `effective_date` date NOT NULL COMMENT 'Gültig ab',
  `title` varchar(200) NOT NULL COMMENT 'Titel der AGB',
  `content` longtext NOT NULL COMMENT 'AGB-Text (HTML)',
  `is_active` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1 = aktuell gültig',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Walls AGB-Versionen';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_wf_wall_bookings`
--

DROP TABLE IF EXISTS `wp_wf_wall_bookings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_wall_bookings` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `wall_id` bigint(20) unsigned NOT NULL,
  `slot_ids` text NOT NULL COMMENT 'JSON-Array der gebuchten Slot-IDs',
  `sponsor_id` bigint(20) unsigned NOT NULL,
  `sponsor_name` varchar(255) NOT NULL,
  `total_slots` int(10) unsigned NOT NULL DEFAULT 0,
  `total_area_sqm` decimal(8,2) NOT NULL DEFAULT 0.00,
  `total_area_percent` decimal(5,2) NOT NULL DEFAULT 0.00,
  `price_per_month` decimal(10,2) NOT NULL DEFAULT 0.00,
  `total_price` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Monatspreis × Laufzeit',
  `currency` varchar(3) DEFAULT 'CP',
  `billing_cycle` varchar(20) DEFAULT 'monthly' COMMENT 'monthly, quarterly, yearly',
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=entwurf, 1=aktiv, 2=gekündigt, 3=abgelaufen, 4=storniert',
  `auto_renew` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1=automatisch verlängern',
  `design_url` varchar(500) DEFAULT NULL,
  `design_approved_at` datetime DEFAULT NULL,
  `design_approved_by` bigint(20) unsigned DEFAULT NULL COMMENT 'Admin, der freigegeben hat',
  `payment_status` varchar(20) DEFAULT 'pending' COMMENT 'pending, paid, overdue, refunded',
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `wall_id` (`wall_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AdCityCentral Walls - Buchungsverträge';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_wf_wall_interactions`
--

DROP TABLE IF EXISTS `wp_wf_wall_interactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_wall_interactions` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `wall_id` bigint(20) unsigned NOT NULL,
  `slot_id` bigint(20) unsigned DEFAULT NULL,
  `interaction_type` varchar(20) NOT NULL COMMENT 'scan, click, impression',
  ...
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AdCityCentral Walls - Tracking';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_wf_wall_slots`
--

DROP TABLE IF EXISTS `wp_wf_wall_slots`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_wall_slots` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `wall_id` bigint(20) unsigned NOT NULL,
  `slot_key` varchar(20) NOT NULL COMMENT 'z.B. A1, B3, C2 (Row+Col)',
  `row_num` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `col_num` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `width_percent` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT 'Breite in % der Wand',
  `height_percent` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT 'Höhe in % der Wand',
  `area_percent` decimal(5,2) NOT NULL DEFAULT 0.00 COMMENT 'Fläche in % der Wand',
  `area_sqm` decimal(6,2) NOT NULL DEFAULT 0.00 COMMENT 'Fläche in m²',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=frei, 1=gebucht, 2=reserviert, 3=gesperrt',
  `price_per_month` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Monatspreis für diesen Slot',
  `currency` varchar(3) DEFAULT 'CP',
  `booked_by` bigint(20) unsigned DEFAULT NULL COMMENT 'sponsor_id (wf_user.id)',
  `booked_at` datetime DEFAULT NULL,
  `expires_at` datetime DEFAULT NULL,
  `campaign_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Verknüpfung zu wf_campaigns',
  `sponsor_name` varchar(255) DEFAULT NULL COMMENT 'Name des Sponsors (cached)',
  `sponsor_logo_url` varchar(500) DEFAULT NULL COMMENT 'Logo-URL (cached)',
  `sponsor_link_url` varchar(500) DEFAULT NULL COMMENT 'Ziel-URL (cached)',
  `design_approved` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1=Künstler-Design vom Sponsor freigegeben',
  `design_url` varchar(500) DEFAULT NULL COMMENT 'Entwurf/Gemälde-Design',
  `final_photo_url` varchar(500) DEFAULT NULL COMMENT 'Foto des fertigen Gemäldes auf der Wand',
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `wall_slot` (`wall_id`,`slot_key`),
  KEY `wall_id` (`wall_id`),
  KEY `status` (`status`),
  KEY `booked_by` (`booked_by`),
  KEY `campaign_id` (`campaign_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AdCityCentral Walls - Buchbare Slots';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_wf_wall_subscriptions`
--

DROP TABLE IF EXISTS `wp_wf_wall_subscriptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_wall_subscriptions` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL COMMENT 'Sponsor (wf_user.id)',
  `plan_id` bigint(20) unsigned NOT NULL COMMENT 'Verknüpfung zu plans',
  `plan_slug` varchar(32) NOT NULL COMMENT 'basic, pro, premium, enterprise',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=pending, 1=active, 2=cancelled, 3=expired, 4=paused',
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `auto_renew` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Auto-Verlängerung',
  `monthly_fee` decimal(10,2) NOT NULL DEFAULT 0.00,
  `currency` varchar(3) NOT NULL DEFAULT 'CP',
  `payment_method` varchar(20) NOT NULL DEFAULT 'paypal' COMMENT 'paypal, gsc, cp, free',
  `paypal_subscription_id` varchar(100) DEFAULT NULL COMMENT 'PayPal Subscription ID',
  `paypal_order_id` varchar(100) DEFAULT NULL COMMENT 'PayPal Order ID',
  `slots_used` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Aktuell gebuchte Slots',
  `slots_total` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Max. Slots laut Plan',
  `discount_pct` decimal(5,2) NOT NULL DEFAULT 0.00,
  `agb_accepted` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'AGB akzeptiert?',
  `agb_version` varchar(20) DEFAULT NULL COMMENT 'z.B. v2.1-2026-06-12',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Walls ABO-Abonnements';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_wf_walls`
--

DROP TABLE IF EXISTS `wp_wf_walls`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_walls` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `slug` varchar(64) NOT NULL COMMENT 'URL-freundlicher Name, z.B. briller-kreuz-01',
  `name` varchar(255) NOT NULL COMMENT 'Anzeigename, z.B. Briller Kreuz - Lärmschutzwand',
  `description` text DEFAULT NULL COMMENT 'Beschreibung der Wand, Lage, Sichtbarkeit',
  `location` varchar(255) DEFAULT NULL COMMENT 'Adresse / Standort',
  `city` varchar(100) DEFAULT 'Wuppertal' COMMENT 'Stadt',
  `country` varchar(2) DEFAULT 'DE' COMMENT 'ISO-Ländercode',
  `width_m` decimal(6,2) NOT NULL DEFAULT 0.00 COMMENT 'Breite in Metern',
  `height_m` decimal(6,2) NOT NULL DEFAULT 0.00 COMMENT 'Höhe in Metern',
  `area_sqm` decimal(8,2) NOT NULL DEFAULT 0.00 COMMENT 'Fläche in m² (berechnet)',
  `photo_url` varchar(500) DEFAULT NULL COMMENT 'Foto der Wand (Bernds Handy-Foto)',
  `photo_artist` varchar(255) DEFAULT NULL COMMENT 'Künstler, der das Foto/Wandgemälde erstellt',
  `grid_rows` tinyint(3) unsigned NOT NULL DEFAULT 4 COMMENT 'Grid-Zeilen (Standard 4)',
  `grid_cols` tinyint(3) unsigned NOT NULL DEFAULT 6 COMMENT 'Grid-Spalten (Standard 6)',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=entwurf, 1=aktiv, 2=gesperrt, 3=archiviert',
  `base_price_per_sqm` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Grundpreis pro m²/Monat in CP oder €',
  `currency` varchar(3) DEFAULT 'CP' COMMENT 'CP oder EUR',
  `booking_unit` varchar(20) DEFAULT 'slot' COMMENT 'slot=per Grid-Slot, sqm=pro m², percent=prozentual',
  `featured` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1=Featured auf Übersichtsseite',
  `traffic_estimate_daily` int(10) unsigned DEFAULT 0 COMMENT 'Geschätzte Passanten/Tag',
  `qr_code_url` varchar(500) DEFAULT NULL COMMENT 'QR-Code Bild-URL für physische Wand',
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `slug` (`slug`),
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AdCityCentral Walls - Physische Werbewände';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_wf_website_ratings`
--

DROP TABLE IF EXISTS `wp_wf_website_ratings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_website_ratings` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_rating` (`website_id`,`rater_user_id`),
  KEY `idx_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wp_wf_werbeaktionen`
--

DROP TABLE IF EXISTS `wp_wf_werbeaktionen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wf_werbeaktionen` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `art` varchar(50) NOT NULL DEFAULT '',
  `offen` int(11) NOT NULL DEFAULT 10,
  `kamp_klicks` int(11) NOT NULL DEFAULT 500,
  `kamp_zeit` int(11) NOT NULL DEFAULT 30,
  `kamp_reload` int(11) NOT NULL DEFAULT 2,
  `kamp_wert` decimal(10,4) NOT NULL DEFAULT 0.0000,
...
--
-- Table structure for table `wp_wpl_cookie_scan`
--

DROP TABLE IF EXISTS `wp_wpl_cookie_scan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wpl_cookie_scan` (
  `id_wpl_cookie_scan` int(11) NOT NULL AUTO_INCREMENT,
  `status` int(11) NOT NULL DEFAULT 0,
  `created_at` int(11) NOT NULL DEFAULT 0,
  `total_url` int(11) NOT NULL DEFAULT 0,
  `total_cookies` int(11) NOT NULL DEFAULT 0,
  `total_category` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `wp_wpl_cookie_scan_cookies`
--
...
CREATE TABLE `wp_wpl_cookie_scan_cookies` (
  `id_wpl_cookie_scan_cookies` int(11) NOT NULL AUTO_INCREMENT,
  `id_wpl_cookie_scan` int(11) NOT NULL DEFAULT 0,
  `id_wpl_cookie_scan_url` int(11) NOT NULL DEFAULT 0,
  `name` varchar(50) NOT NULL,
...
--
-- Table structure for table `wp_wpl_cookie_scan_url`
--
...
CREATE TABLE `wp_wpl_cookie_scan_url` (
  `id_wpl_cookie_scan_url` int(11) NOT NULL AUTO_INCREMENT,
  `id_wpl_cookie_scan` int(11) NOT NULL DEFAULT 0,
  `url` text NOT NULL,
...
--
-- Table structure for table `wp_wpl_cookie_scripts`
--
...
CREATE TABLE `wp_wpl_cookie_scripts` (
  ...
  `script_category` int(11) NOT NULL,
...
--
-- Table structure for table `wp_wpl_data_req`
--

DROP TABLE IF EXISTS `wp_wpl_data_req`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_wpl_data_req` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
