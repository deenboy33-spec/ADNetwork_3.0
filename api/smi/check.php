<?php
/**
 * ADNetwork 3.0 - SMI Check API
 * User-Validierung für externen Partner
 * 
 * Parameter:
...
$log_file = __DIR__ . '/../../logs/smi_check.log';
$log_entry = date('Y-m-d H:i:s') . " | Check API | mi_id=$mi_id | s_id=$s_id\n";
...
try {
    ...
    // Erfolg: User-ID zurückgeben
    echo $user['userid'];
    file_put_contents($log_file, date('Y-m-d H:i:s') . " | ERFOLG: User validiert (ID: {$user['userid']})\n", FILE_APPEND | LOCK_EX);
